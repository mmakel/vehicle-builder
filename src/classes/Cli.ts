...
class Cli {
  ...
  findVehicleToTow(Truck: Truck){
    const towCapacity = Truck.towingCapacity;
    const towVin = Truck.vin;
    inquirer
      .prompt([
        {
          type: 'list',
      ...
      .then((answers) => {
        ...
        if(answers.vehicleToTow.vin === towVin){
          console.log('The truck cannot tow itself');
          this.performActions();
        }
        else if(answers.vehicleToTow.weight > towCapacity){
          console.log('The selected vehicle is too heavy to be towed');
          this.performActions();
        }
        else{
